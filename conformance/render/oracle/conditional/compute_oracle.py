#!/usr/bin/env python3
# Concern: INDEPENDENT ground-truth evaluator for the customer_tiers sheet (pure python, no charlie) | Non-concern: parsing the on-disk .range grammar (values are transcribed by hand from the input files below) | IO: output
"""Independently compute the rendered values for artifacts/conditional/customer_tiers.

Ground truth is derived here in plain python, NOT by charlie (oracle-input purity).
