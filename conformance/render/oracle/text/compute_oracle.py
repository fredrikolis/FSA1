#!/usr/bin/env python3
# Concern: independent ground-truth computation for the contacts-clean sheet | Non-concern: charlie itself (must NEVER produce this truth) | IO: output
"""
...
relevant Excel/charlie text semantics in plain Python. It does NOT call charlie.
...
Excel/charlie semantics re-implemented here:
