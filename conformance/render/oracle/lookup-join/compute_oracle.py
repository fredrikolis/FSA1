#!/usr/bin/env python3
# Concern: independently compute the correct rendered values for the lookup-join sheet | Non-concern: FSA1 itself (this must NOT call FSA1 — oracle-input purity) | IO: output
#
